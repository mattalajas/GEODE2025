...
pip install matplotlib scikit-learn ipykernel tensorboard haversine omegaconf tables seaborn torch-geometric-temporal
pip install git+https://github.com/TorchSpatiotemporal/tsl.git 
pip install hydra-core geopandas geodatasets 
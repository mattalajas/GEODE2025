...
class GeodeCrossV14(BaseModel):
    def __init__(self,
                 ...
                 att_heads=8,
                 dropout=0.1):
        super(GeodeCrossV14, self).__init__()
    ...
    def forward(self,
        ...
        # ========================================
        a_fwd = self.full_tras(a_fwd, o_adj)
        cr_embs = self.full_tras(cr_embs, cross_adj)
        ...
        exog_inds = list(range(xh_air_2.shape[2], xh_cro_2.shape[2]))
        cro_inds = grouped[0] + exog_inds
